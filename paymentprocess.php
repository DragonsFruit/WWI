    ...
    <div class="row">
        <div class="col-12">
			...
			<ul class="nav nav-tabs tab-nav-main" id="myTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="bevestig-tab" data-toggle="tab" href="#nav-bevestig" role="tab" aria-controls="nav-bevestig" aria-selected="true">Customer Information</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="product-betaling-tab" data-toggle="tab" href="#nav-product-betaling" role="tab" aria-controls="nav-product-feedback" aria-selected="false">Payment</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="product-klaar-tab" data-toggle="tab" href="#nav-product-klaar" role="tab" aria-controls="nav-product-shipping" aria-selected="false">Confirm</a>
				</li>
			</ul>
            <div class="tab-content" id="nav-tabContent">
						...
						<form class="mt-3">
							...
							<div class="form-group">
								<div class="form-check">
									...
									<label class="form-check-label" for="gridCheck">Yes, I want to be informed about future deals and discounts.</label>
									<br>
									<input class="form-check-input" type="checkbox" id="gridCheck" required>
									<label class="form-check-label" for="gridCheck">I agree with the terms and conditions.</label>
								</div>
							</div>
                ...
                <div class="tab-pane fade show" id="nav-product-betaling" role="tabpanel" aria-labelledby="product-betaling-tab">
					<div id="payment-form">
						<div><p>Total Amount: <?php print ($totaal);  ?> <!-- moet gevuld worden met een echo van het totaalbedrag --></p></div>
