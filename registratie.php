<?php
    ...
    if (isset($_POST["Naam"]) &&
        ...
        $registration->registerUserWith($firstName,$lastName,1,1,1,1 );
    }
 ?>

<div class="container">
    <div class="row">
    <form style="display:block; margin-left:auto; margin-right:auto" method="post">
            <div class="col-xs-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Wachtwoord" placeholder="Wachtwoord" required="">
                </div> -->
                <div class="form-group">
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    <label for="Huisnummer_toevoeging1">Huisnummer + toevoeging</label>
                    <input type="text" class="form-control" id="Huisnummer_toevoeging" name="Huisnummer_toevoeging" placeholder="Huisnummer_toevoeging" required="">
                </div>
                <div class="form-group">
                    <label for="Straatnaam">Straatnaam</label>
                    <input type="text" class="form-control" id="Straat" name="Straat" placeholder="Straatnaam" required="">
                </div>
                <div class="form-group">
